...
export default function CodeEditor({
  ...
  const handleSubmit = async () => {
    ...
    // res is the API envelope { statusCode, message, data: {...} }
    ...
    if (result.allPassed) {
      toast.success(`Accepted — ${passed}/${total} test cases passed`, {
        id: "submit",
      });
    } else {
      toast.error(`${passed}/${total} test cases passed`, { id: "submit" });
    }

    // surface the result in-page: switch to the Submission tab + refresh it
    onSubmitted?.();
  };
