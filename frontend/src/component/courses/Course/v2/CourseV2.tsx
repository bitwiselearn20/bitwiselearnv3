...
import SectionCodingProblems from "./SectionCodingProblems";
          ...
          >
            ...
            {section.isOpen && (
              ...
              >
                ...
                {/* Coding problems attached to this section (with solved status) */}
                <div className="px-6 pb-3">
                  <SectionCodingProblems sectionId={section.id} />
                </div>
              </div>
            )}
          </div>
