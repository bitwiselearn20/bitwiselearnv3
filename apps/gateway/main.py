...
async def proxy(request: Request, path: str):
    ...
    # follow_redirects=True so FastAPI's trailing-slash 307s are resolved
    # internally — otherwise the redirect Location leaks the internal service
    # host (e.g. localhost:8004) to the browser, which can't reach it.
